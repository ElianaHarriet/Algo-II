...
static void prueba_crear_hash_vacio() // -> Ok
{
...
static void prueba_iterar_hash_vacio() // -> Ok
{
...
static void prueba_hash_insertar() // -> Ok
{
    printf("\nPRUEBA INSERTAR\n");
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_reemplazar() // -> Ok
{
    printf("\nPRUEBA REEMPLAZAR\n");
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_reemplazar_con_destruir() // -> Ok
{
...
static void prueba_hash_borrar() // -> Ok
{
    printf("\nPRUEBA BORRAR\n");
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_clave_vacia() // -> Ok
{
    printf("\nPRUEBA CLAVE VACIA\n");
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_valor_null() // -> Ok
{
    printf("\nPRUEBA VALOR NULL\n");
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_volumen(size_t largo, bool debug) // -> Ok
{
    // printf("\nPRUEBA VOLUMEN\n");
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_iterar() // -> Ok
{
    printf("\nPRUEBA ITERAR\n");
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_iterar_volumen(size_t largo) // -> Ok
{
    printf("\nPRUEBA ITERAR VOLUMEN\n");
    hash_t* hash = hash_crear(NULL);
    ...
    print_test("Prueba hash iteración en volumen, se cambiaron todos los elementos", ok);
